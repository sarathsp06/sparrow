  ...
  "rpcs": [
    {
      ...
      "description": "GetWebhookHealth returns health status and detailed metrics for a single webhook: total/successful/failed deliveries, consecutive failures, success rate, avg response time, and error category breakdown (client/server/timeout/network errors). Returns HEALTH_UNSPECIFIED with no metrics if the webhook has no delivery history.",
      "request": [
        {
          "name": "webhook_id",
          "type": "string",
      ...
      "response": [
        ...
        {
          "name": "metrics.webhook_id",
          "type": "string",
          "description": "UUID of the webhook these metrics belong to."
        },
        {
        ...
        {
          "name": "metrics.last_success_at",
          "type": "Timestamp",
          "description": "Timestamp of the most recent successful delivery. Null if the webhook has never succeeded."
        },
        {
          "name": "metrics.last_failure_at",
          "type": "Timestamp",
          "description": "Timestamp of the most recent failed delivery. Null if the webhook has never failed."
        },
        {
        ...
        {
          "name": "metrics.created_at",
          "type": "Timestamp",
          "description": "When the health metrics record was first created."
        },
        {
          "name": "metrics.updated_at",
          "type": "Timestamp",
          "description": "When the health metrics were last updated."
        },
        {
    ...
    },
    {
      ...
      "description": "ListWebhooksByHealth returns all webhooks matching a given health status. Useful for finding degraded or unhealthy endpoints. Paginated.",
      "request": [
        {
          "name": "health",
          "type": "WebhookHealth",
    ...
    },
    {
      ...
      "description": "GetHealthSummary returns aggregate counts of webhooks by health status (healthy, degraded, unhealthy, unknown) across all namespaces.",
      "request": [],
      "response": [
        {
