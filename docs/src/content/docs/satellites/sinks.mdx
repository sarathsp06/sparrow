---
title: Sinks
description: Forward Sparrow deliveries to non-HTTP destinations — SMTP email, S3 archives, and OTLP log export — with the sparrow-sinks binary.
---
...
Each delivery becomes one OTLP/HTTP JSON log record: the event payload as the
