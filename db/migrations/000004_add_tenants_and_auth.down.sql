...
DROP INDEX IF EXISTS idx_event_records_tenant_consumer;
DROP INDEX IF EXISTS idx_event_records_tenant;
DROP INDEX IF EXISTS idx_event_subscriptions_tenant_consumer;
DROP INDEX IF EXISTS idx_event_subscriptions_tenant;
DROP INDEX IF EXISTS idx_webhook_registrations_tenant_consumer;
...
ALTER TABLE event_subscriptions ADD CONSTRAINT event_subscriptions_webhook_id_event_name_consumer_key UNIQUE (webhook_id, event_name, consumer);

DROP INDEX IF EXISTS idx_webhook_registrations_tenant_consumer_url;
ALTER TABLE webhook_registrations ADD CONSTRAINT unique_consumer_url UNIQUE (consumer, url);
