  ...
  <div class="flex flex-col h-full">
    ...
    <div class="p-3 border-t border-line space-y-3">
      ...
      <div class="flex items-center gap-1 text-muted">
        ...
        <a href="https://github.com/sarathsp06/sparrow" target="_blank" rel="noreferrer" aria-label="Star Sparrow on GitHub" class="flex-1 inline-flex items-center justify-center gap-1.5 px-2 py-1.5 rounded-md text-xs hover:text-text hover:bg-black/5 transition-colors">
