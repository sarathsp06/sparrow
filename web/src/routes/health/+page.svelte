				...
				<div class="mb-6">
					...
					<div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
						<div class="bg-white p-4 rounded-lg shadow-sm border text-center">
							<p class="text-2xl font-bold text-green-500">{healthSummary.healthyCount}</p>
							<p class="text-gray-600">Healthy</p>
						</div>
						<div class="bg-white p-4 rounded-lg shadow-sm border text-center">
							<p class="text-2xl font-bold text-yellow-500">{healthSummary.degradedCount}</p>
							<p class="text-gray-600">Degraded</p>
						</div>
						<div class="bg-white p-4 rounded-lg shadow-sm border text-center">
							<p class="text-2xl font-bold text-red-500">{healthSummary.unhealthyCount}</p>
							<p class="text-gray-600">Unhealthy</p>
						</div>
						<div class="bg-white p-4 rounded-lg shadow-sm border text-center">
							<p class="text-2xl font-bold text-gray-500">{healthSummary.unknownCount}</p>
				...
				<div>
					...
					<div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
						...
						<div class="bg-white p-4 rounded-lg shadow-sm border">
							...
							<p class="text-2xl font-bold">{(namespaceStats.successRate * 100).toFixed(2)}%</p>
						</div>
						<div class="bg-white p-4 rounded-lg shadow-sm border">
							<p class="font-semibold text-gray-600">Successful Deliveries</p>
							<p class="text-2xl font-bold">{namespaceStats.successfulDeliveries}</p>
						</div>
						<div class="bg-white p-4 rounded-lg shadow-sm border">
							<p class="font-semibold text-gray-600">Failed Deliveries</p>
							<p class="text-2xl font-bold">{namespaceStats.failedDeliveries}</p>
						</div>
						<div class="bg-white p-4 rounded-lg shadow-sm border">
							<p class="font-semibold text-gray-600">Pending Deliveries</p>
							<p class="text-2xl font-bold">{namespaceStats.pendingDeliveries}</p>
						</div>
					</div>
				</div>
			{/if}
