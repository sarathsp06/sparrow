...
For step-by-step integration guides, see the [SDK Guides](https://sarathsp06.github.io/sparrow/guides/go/):

- [Go SDK Guide](https://sarathsp06.github.io/sparrow/guides/go/)
- [Python SDK Guide](https://sarathsp06.github.io/sparrow/guides/python/)
- [TypeScript SDK Guide](https://sarathsp06.github.io/sparrow/guides/typescript/)
...
The Go client packages are part of the main Sparrow module:
...
Copy the generated stubs into your project:
...
// Register a webhook
const resp = await webhookClient.registerWebhook({
  namespace: "default",
  url: "https://example.com/webhook",
  events: ["order.created"],
  active: true,
});
console.log("Webhook ID:", resp.webhookId);

// Push an event
const pushResp = await eventClient.pushEvent({
  namespace: "default",
  event: "order.created",
  payload: { order_id: "ord_456", total: 149.99 },
  ttlSeconds: 3600,
});
...
Or install the Sparrow Python client package from source:
